...
slug: "deploy-your-own-vector-tile-server-while-getting-your-kids-ready-for-school"
publishedAt: "2018-06-26"
author: "david-heyman"
authorName: "David Heyman"
summary: "TL;DR Go here if you want the instructions without the extended bit about parenting."
coverImage: "/images/blog/deploy-your-own-vector-tile-server-while-getting-your-kids-ready-for-school-cover.png"
---

_TL;DR Go_ [_here if you want the instructions_](https://gist.github.com/davidheyman/ce14f17caf2ab6add3c70a881f06b4ae) _without the extended bit about parenting._
...
```
for f in *.shp;
do    mapshaper $f -o format=geojson ../geojson/`basename $f .shp`.json;
   done
```
...
![](/images/blog/deploy-your-own-vector-tile-server-while-getting-your-kids-ready-for-school/1.png)
...
![](/images/blog/deploy-your-own-vector-tile-server-while-getting-your-kids-ready-for-school/2.png)
