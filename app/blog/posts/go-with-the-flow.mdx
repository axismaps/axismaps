...
![](/images/blog/go-with-the-flow/2.jpg)

![](/images/blog/go-with-the-flow/3.jpg)
...
Now that I had contours, all I needed to do was draw evenly spaced marks perpendicular to each contour, right? Well as usual, it _kind of_ works but breaks down easily. For me, at least, perhaps hachuring will always stubbornly be the same hand-drawn technique as when it was born (I'm working on that a bit, too).

![](/images/blog/go-with-the-flow/5.jpg)
...
![](/images/blog/go-with-the-flow/6.jpg)
...
![](/images/blog/go-with-the-flow/7.jpg)

*Once more, with fun colors.*

![](/images/blog/go-with-the-flow/8.jpg)

*Mount Fuji, if I recall correctly*

![](/images/blog/go-with-the-flow/9.jpg)

*Hawaii*

![](/images/blog/go-with-the-flow/10.jpg)
...
It only dawned on me last week that a solution, if one was needed, is simply to draw lines the other way, going _uphill_ from each contour. They start with even spacing at low elevations and begin to converge on ridgelines and summits. Finally I could see the structure of the terrain!

![](/images/blog/go-with-the-flow/11.jpg)

*The same map extent drawn with lines running downhill (left) and uphill (right).*

![](/images/blog/go-with-the-flow/12.jpg)

*Around White Mountain Peak, California*

![](/images/blog/go-with-the-flow/13.jpg)
...
1.  Get elevation data from terrain tiles and compute contours (as described in [this post](https://github.com/axismaps/axis-jekyll/blob/master/blog/2018/04/contours-in-browser)about the contours tool)
