...
**_Not sure you should use a dot density map?_** Potential alternatives include [choropleth](/guide/choropleth) maps (if your data can be standardized and are attached to enumeration units), [graduated/proportional symbol](/guide/proportional-symbols) maps, and [cartograms](/guide/cartograms).
