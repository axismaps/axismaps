...
A simple definition is that **a map is a _representation_ of a place.** This carries two important implications that are sometimes neglected:
...
![](/images/guide/reference_maps.jpeg)
