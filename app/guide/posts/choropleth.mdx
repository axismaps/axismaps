...
**_Not sure you should use a choropleth map?_** Good alternatives include [dot density maps](http://www.axismaps.com.s3-website-us-east-1.amazonaws.com/guide/univariate/dot-density), [graduated/proportional symbol](http://www.axismaps.com.s3-website-us-east-1.amazonaws.com/guide/univariate/proportional-symbols) maps, and [cartograms](http://www.axismaps.com.s3-website-us-east-1.amazonaws.com/guide/univariate/cartograms): Furthermore, while choropleth maps require that your data are standardized (rates, ratios…e.g., _X per square kilometer_ or _Y per 100,000 people_), these other 3 map types can all handle raw data (e.g., simple counts, totals).

## Example Classed Choropleth Map

Below is a 5-class choropleth map that uses a [sequential color scheme](http://www.axismaps.com.s3-website-us-east-1.amazonaws.com/guide/general/using-colors-on-maps) (from light to dark) attached to an equal-interval classification scheme.

![](/images/guide/classed_choropleth.jpeg)
...
![](/images/guide/histogram_examples.png)
...
![](/images/guide/unclassed_ramp.jpeg)
...
![](/images/guide/unclassed_choropleth_map.jpeg)
