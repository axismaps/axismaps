...
**NOTE:** If you want to make a [choropleth map](http://www.axismaps.com.s3-website-us-east-1.amazonaws.com/guide/univariate/choropleth), you MUST map only standardized data.
